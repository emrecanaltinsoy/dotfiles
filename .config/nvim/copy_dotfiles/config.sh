...
confedit_list[xmobar0]="$HOME/.config/xmobar/xmobarrc0"
confedit_list[xmobar1]="$HOME/.config/xmobar/xmobarrc1"
confedit_list[xmobar2]="$HOME/.config/xmobar/xmobarrc2"
