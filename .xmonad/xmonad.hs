...
myWorkspaces = [" dev ", " www ", " code ", " doc ", " vbox ", " chat ", " mus ", " vid ", " gfx "]
...
myManageHook = composeAll
     ...
     , title =? "obs-studio"                 --> doShift ( myWorkspaces !! 7 )
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              , ppHidden = xmobarColor "#995AFF" "" . wrap "*" "" . clickable -- Hidden workspaces
